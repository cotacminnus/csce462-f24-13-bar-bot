import os
from facial_recognition_mediapipe import FacialRecognition
...
def test_face_recog():
    ...
    try:
        # Run the face recognition method
        result = FacialRecognition.face_recog(image_path=sample_image_path)
        assert isinstance(result, bool), "face_recog did not return a boolean value."
...
def test_detect_face_with_webcam():
    ...
    """
    try:
        # Detect faces directly using the webcam
